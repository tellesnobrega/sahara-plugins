...
from sahara_plugins.plugins.vanilla import abstractversionhandler as avm
from sahara_plugins.plugins.vanilla.hadoop2 import config as c
from sahara_plugins.plugins.vanilla.hadoop2 import keypairs
from sahara_plugins.plugins.vanilla.hadoop2 import recommendations_utils as ru
from sahara_plugins.plugins.vanilla.hadoop2 import run_scripts as run
from sahara_plugins.plugins.vanilla.hadoop2 import scaling as sc
from sahara_plugins.plugins.vanilla.hadoop2 import starting_scripts as s_script
from sahara_plugins.plugins.vanilla.hadoop2 import utils as u
from sahara_plugins.plugins.vanilla.hadoop2 import validation as vl
from sahara_plugins.plugins.vanilla import utils as vu
from sahara_plugins.plugins.vanilla.v2_8_2 import config_helper as c_helper
from sahara_plugins.plugins.vanilla.v2_8_2 import edp_engine
...
class VersionHandler(avm.AbstractVersionHandler):
    ...
    def start_cluster(self, cluster):
        ...
        s_script.start_namenode(cluster)
        s_script.start_secondarynamenode(cluster)
        s_script.start_resourcemanager(cluster)

        run.start_dn_nm_processes(utils.get_instances(cluster))
        run.await_datanodes(cluster)

        s_script.start_historyserver(cluster)
        s_script.start_oozie(self.pctx, cluster)
        s_script.start_hiveserver(self.pctx, cluster)
        s_script.start_zookeeper(cluster)

        swift_helper.install_ssl_certs(utils.get_instances(cluster))

        self._set_cluster_info(cluster)
        s_script.start_spark(cluster)
