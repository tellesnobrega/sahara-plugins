...
import sahara_plugins.plugins.mapr.abstract.configurer as ac
from sahara_plugins.plugins.mapr.domain import distro as d
from sahara_plugins.plugins.mapr.domain import service as srvc
import sahara_plugins.plugins.mapr.services.management.management as mng
...
from sahara_plugins.plugins.mapr.services.mysql import mysql
import sahara_plugins.plugins.mapr.services.yarn.yarn as yarn
from sahara_plugins.plugins.mapr.util import event_log as el
import sahara_plugins.plugins.mapr.util.general as util
...
class BaseConfigurer(ac.AbstractConfigurer):
    ...
    def _configure_topology(self, cluster_context, instances):
        ...
        script = utils.get_file_text(_TOPO_SCRIPT, 'sahara_plugins')
