...
from sahara_plugins.plugins.ambari import ha_helper as ha
...
class HAHelperTestCase(base.SaharaTestCase):
    ...
    @mock.patch("sahara_plugins.plugins.ambari.ha_helper._set_high_zk_limits")
    @mock.patch("sahara_plugins.plugins.ambari.ha_helper._set_default_fs")
    ...
    @mock.patch("sahara_plugins.plugins.ambari.ha_helper._configure_hdfs_site")
    @mock.patch("sahara_plugins.plugins.ambari.ha_helper._set_zk_quorum")
    @mock.patch("sahara_plugins.plugins.ambari.ha_helper."
    ...
    @mock.patch("sahara_plugins.plugins.ambari.ha_helper._set_default_fs")
    @mock.patch("sahara_plugins.plugins.ambari.ha_helper._set_zk_quorum")
    @mock.patch("sahara_plugins.plugins.ambari.ha_helper._configure_yarn_site")
    ...
    @mock.patch("sahara_plugins.plugins.ambari.ha_helper._confgure_hbase_site")
