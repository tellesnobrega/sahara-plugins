...
class TestAmbariHealthCheck(base.SaharaTestCase):
    ...
    @mock.patch('sahara_plugins.plugins.ambari.client.AmbariClient.__init__')
    @mock.patch('sahara_plugins.plugins.ambari.client.AmbariClient.close')
    @mock.patch('sahara_plugins.plugins.ambari.client.AmbariClient.'
                'get_alerts_data')
