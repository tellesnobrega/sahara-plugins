...
from sahara_plugins.plugins.vanilla.v2_8_2.edp_engine import EdpOozieEngine
from sahara_plugins.plugins.vanilla.v2_8_2.edp_engine import EdpSparkEngine
from sahara_plugins.plugins.vanilla.v2_8_2 import versionhandler as v_h
...
class VersionHandlerTest(base.SaharaTestCase):
    plugin_path = 'sahara_plugins.plugins.vanilla.'
    plugin_hadoop2_path = 'sahara_plugins.plugins.vanilla.hadoop2.'
    ...
    @mock.patch(plugin_path +
                'v2_8_2.versionhandler.VersionHandler.update_infra')
    ...
    @mock.patch(plugin_path + 'v2_8_2.versionhandler.run')
    @mock.patch(plugin_path + 'v2_8_2.versionhandler.s_script')
