...
from sahara_plugins.plugins.vanilla.v2_8_2 import config_helper as v_helper
from sahara_plugins.tests.unit import base


class TestConfigHelper(base.SaharaTestCase):

    plugin_path = 'sahara_plugins.plugins.vanilla.v2_8_2.'
    plugin_hadoop_path = 'sahara_plugins.plugins.vanilla.hadoop2.'
