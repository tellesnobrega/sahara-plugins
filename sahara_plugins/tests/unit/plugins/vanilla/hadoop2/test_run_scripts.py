...
from sahara_plugins.plugins.vanilla.hadoop2 import run_scripts as rs
from sahara_plugins.tests.unit import base


class RunScriptsTest(base.SaharaTestCase):

    PLUGINS_PATH = 'sahara_plugins.plugins.vanilla.hadoop2.'
    ...
    @mock.patch('sahara_plugins.plugins.vanilla.utils.get_namenode')
    @mock.patch('sahara.plugins.utils.check_cluster_exists')
    @mock.patch('sahara.plugins.utils.add_provisioning_step')
    ...
    @mock.patch('sahara_plugins.plugins.vanilla.utils.get_resourcemanager')
    @mock.patch('sahara.plugins.utils.check_cluster_exists')
    @mock.patch('sahara.plugins.utils.add_provisioning_step')
    ...
    @mock.patch('sahara_plugins.plugins.vanilla.utils.get_namenode')
    @mock.patch('sahara_plugins.plugins.vanilla.utils.get_datanodes')
    @mock.patch('sahara.plugins.utils.check_cluster_exists')
    @mock.patch('sahara.plugins.utils.add_provisioning_step')
    ...
    @mock.patch('sahara_plugins.plugins.vanilla.utils.get_oozie')
    @mock.patch('sahara.plugins.context.set_current_instance_id')
    @mock.patch('sahara.plugins.utils.check_cluster_exists')
    @mock.patch('sahara.plugins.utils.add_provisioning_step')
