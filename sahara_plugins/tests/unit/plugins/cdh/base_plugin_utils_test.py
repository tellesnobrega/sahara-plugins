...
from sahara_plugins.tests.unit import base as b
...
class TestPluginUtils(b.SaharaTestCase):
    ...
    @mock.patch('sahara_plugins.plugins.cdh.plugin_utils.'
    ...
    @mock.patch('sahara.config.CONF.disable_event_log')
    @mock.patch('sahara_plugins.plugins.cdh.commands.install_packages')
    ...
    @mock.patch('sahara.config.CONF.disable_event_log')
    @mock.patch('sahara_plugins.plugins.cdh.commands.start_agent')
    @mock.patch('sahara_plugins.plugins.cdh.commands.configure_agent')
    ...
    @mock.patch('sahara.config.CONF.disable_event_log')
    @mock.patch('sahara_plugins.plugins.cdh.commands.is_ubuntu_os')
    @mock.patch('sahara_plugins.plugins.cdh.commands.is_centos_os')
    @mock.patch('sahara_plugins.plugins.cdh.commands.update_repository')
    @mock.patch('sahara_plugins.plugins.cdh.commands.add_apt_key')
    @mock.patch('sahara_plugins.plugins.cdh.commands.write_ubuntu_repository')
    @mock.patch('sahara_plugins.plugins.cdh.commands.write_centos_repository')
    ...
    @mock.patch('sahara_plugins.plugins.cdh.commands.start_cloudera_db')
    @mock.patch('sahara_plugins.plugins.cdh.commands.start_manager')
