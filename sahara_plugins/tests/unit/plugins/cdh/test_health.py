...
from sahara_plugins.plugins.cdh import health
from sahara_plugins.tests.unit import base as unit_base
...
class TestHealthCheck(unit_base.SaharaTestCase):
    ...
    @mock.patch('sahara_plugins.plugins.cdh.health.HealthStatusProvider.'
                'get_cloudera_health')
    @mock.patch('sahara_plugins.plugins.cdh.health.HealthStatusProvider.'
