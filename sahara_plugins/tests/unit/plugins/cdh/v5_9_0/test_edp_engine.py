...
from sahara_plugins.plugins.cdh.v5_9_0 import edp_engine
from sahara_plugins.tests.unit import base as sahara_base
from sahara_plugins.tests.unit.plugins.cdh import utils as c_u
...
class EdpEngineTestV590(sahara_base.SaharaTestCase):
    ...
    @mock.patch(
        'sahara_plugins.plugins.cdh.confighints_helper.get_possible_hive_config_from',
        return_value={})
    ...
    @mock.patch('sahara_plugins.plugins.cdh.v5_9_0.edp_engine.EdpOozieEngine')
    ...
    @mock.patch(
        'sahara_plugins.plugins.cdh.confighints_helper.'
    ...
    @mock.patch(
        'sahara_plugins.plugins.cdh.confighints_helper.get_possible_pig_config_from',
        return_value={})
    ...
    @mock.patch('sahara.plugins.edp.PluginsSparkJobEngine.'
    ...
    def test_spark_engine_validate_job_execution(self,
        ...
        self.assertRaises(pl_ex.PluginInvalidDataException,
                          eng.validate_job_execution, cluster,
                          mock.Mock(), mock.Mock())
