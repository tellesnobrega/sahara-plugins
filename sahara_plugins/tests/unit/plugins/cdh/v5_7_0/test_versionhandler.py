...
from sahara_plugins.plugins.cdh.v5_7_0 import versionhandler
from sahara_plugins.tests.unit import base


class VersionHandlerTestCase(base.SaharaTestCase):

    plugin_path = "sahara_plugins.plugins.cdh.v5_7_0."
    cloudera_utils_path = plugin_path + "cloudera_utils.ClouderaUtilsV570."
    plugin_utils_path = plugin_path + "plugin_utils.PluginUtilsV570."
