...
class DeployCDHV570(base.SaharaTestCase):
    ...
    @mock.patch("sahara_plugins.plugins.cdh.v5_7_0.deploy.CU")
    ...
    @mock.patch("sahara_plugins.plugins.cdh.v5_7_0.deploy._start_roles")
    @mock.patch("sahara_plugins.plugins.cdh.v5_7_0.deploy.CU")
    ...
    @mock.patch("sahara.plugins.edp.create_hbase_common_lib")
    @mock.patch("sahara_plugins.plugins.cdh.v5_7_0.deploy.CU")
    ...
    @mock.patch("sahara_plugins.plugins.cdh.v5_7_0.deploy."
                "_finish_cluster_starting")
    @mock.patch("sahara_plugins.plugins.cdh.v5_7_0.deploy._prepare_cluster")
    @mock.patch("sahara_plugins.plugins.cdh.v5_7_0.deploy.CU")
