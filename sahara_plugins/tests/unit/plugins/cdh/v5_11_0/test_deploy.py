...
from sahara_plugins.plugins.cdh.v5_11_0 import deploy
from sahara_plugins.tests.unit import base


class DeployCDHV5110(base.SaharaTestCase):

    def setUp(self):
        super(DeployCDHV5110, self).setUp()
        ...
        self.is_cdh_exists = mock.patch(
            "sahara_plugins.plugins.cdh.commands.is_pre_installed_cdh",
            return_value=False)
    ...
    def tearDown(self):
        ...
        super(DeployCDHV5110, self).tearDown()

    @mock.patch("sahara.plugins.utils.get_instances")
    @mock.patch("sahara_plugins.plugins.cdh.v5_11_0.deploy.CU")
    ...
    @mock.patch("sahara_plugins.plugins.cdh.v5_11_0.deploy._start_roles")
    @mock.patch("sahara_plugins.plugins.cdh.v5_11_0.deploy.CU")
    ...
    @mock.patch("sahara_plugins.plugins.cdh.v5_11_0.deploy."
                "_finish_cluster_starting")
    @mock.patch("sahara_plugins.plugins.cdh.v5_11_0.deploy._prepare_cluster")
    @mock.patch("sahara_plugins.plugins.cdh.v5_11_0.deploy.CU")
