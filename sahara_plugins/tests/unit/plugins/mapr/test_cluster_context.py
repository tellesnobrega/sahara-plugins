...
from sahara_plugins.plugins.mapr.domain import node_process as np
from sahara_plugins.plugins.mapr.services.management import management
...
import sahara_plugins.plugins.mapr.versions.v5_2_0_mrv2.context as cc
import sahara_plugins.plugins.mapr.versions.v5_2_0_mrv2.version_handler as hand
...
class TestClusterContext(b.SaharaTestCase):
    ...
    def _get_context(self):
        ...
        return cc.Context(cluster, hand.VersionHandler())
    ...
    def test_get_service(self):
        ...
        with testtools.ExpectedException(e.PluginInvalidDataException):
