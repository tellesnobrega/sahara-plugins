...
import sahara_plugins.plugins.mapr.abstract.cluster_context as abstract_context
from sahara_plugins.plugins.mapr.domain import service as bs
...
class TestHandler(b.SaharaTestCase):
    def __init__(self, *args, **kwds):
        ...
        self.handler = hand.VersionHandler()
